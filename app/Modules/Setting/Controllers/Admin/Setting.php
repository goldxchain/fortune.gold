	...
	public function index()
    {
        ...
        if ($this->validation->withRequest($this->request)->run()){
                    ...
                    if($this->request->getMethod() == "post"){
                        $logo       =   $this->imagelibrary->image($imglogo,$savepath_logo,$old_logo,184,94.31);
                    }
                    ...
                    if($this->request->getMethod() == "post"){
                        $logo_web       =   $this->imagelibrary->image($imglogo_web,$savepath_logo_web,$old_logo_web,163,58);
                    }
